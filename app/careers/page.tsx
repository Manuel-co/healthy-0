          ...
          <div className="px-3 pt-3 pb-3 sm:px-4 sm:pt-4 sm:pb-4 lg:px-5 lg:pt-5 lg:pb-5">
            <div className="w-full rounded-[20px] lg:rounded-[28px] overflow-hidden bg-[#ffffff] px-6 py-12 md:px-10 md:py-16">
              <div className="max-w-[680px] mx-auto">
                ...
                <div className="rounded-[20px] border border-[#071938]/10 bg-[#fffef8] p-8 sm:p-10">
                  ...
                  <h2 className="font-heading text-[22px] sm:text-[24px] font-bold text-[#071938] mb-4">
                    No open positions at the moment
                  </h2>

                  <p className="text-[13.5px] leading-[1.8] text-[#071938]/65 mb-4">
                  ...
                  <p className="text-[13.5px] leading-[1.8] text-[#071938]/65 mb-8">
                ...
                <div className="mt-10 text-center">
                  <Link
                    href="/"
                    className="inline-flex items-center gap-2 text-[13px] font-medium text-[#071938] hover:opacity-70 transition-opacity"
                  >
                    ← Back to Home
                  </Link>
                </div>
